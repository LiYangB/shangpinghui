  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @transport="getTrademark" @getAttr="getAttr" />
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag) {
      ...
      // 判断状态
      let newOrder = "";
      // console.log(orderFlag, orderSort, flag, orderSort == "desc");
      if (flag == orderFlag) {
