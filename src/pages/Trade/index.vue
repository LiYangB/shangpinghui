  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="orderInfo in orderInfo.detailArrayList"
          :key="orderInfo.skuId"
        >
          <li>
            <img :src="orderInfo.imgUrl" style="width: 100px; height: 100px" />
          </li>
          <li>
            <p>
              {{ orderInfo.skuName }}
...
export default {
  ...
  data() {
    return {
      ...
      userAddress: [
        {
          consignee: "李阳",
          fullAddress: "湖南省长沙市岳麓区湖南工商大学",
          id: 1,
          isDefault: 1,
          phoneNum: "15873236724",
          provinceId: 1,
          regionId: 1,
          userAddress: "湖南省长沙市岳麓区湖南工商大学",
          userId: 2,
        },
        {
          consignee: "周叶",
          fullAddress: "湖南省长沙市岳麓区咸嘉花园湖南工商大学",
          id: 2,
          isDefault: 0,
          phoneNum: "15873231456",
          provinceId: 1,
          regionId: 1,
          userAddress: "湖南省长沙市岳麓区咸嘉花园湖南工商大学",
          userId: 2,
        },
      ],
      orderId: "",
  ...
  mounted() {
    // 获取用户地址
    this.$store.commit("GETUSEERADDRESS", this.userAddress);
    // 获取用户购物车信息
